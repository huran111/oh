...
public class CodeGenerator {
    ...
    public static PackageConfig packageConfig(AutoGenerator mpg,String moduleName){
        ...
        pc.setParent("com.tykj");
        mpg.setPackageInfo(pc);
        return pc;
    }

    public static void injectionConfig(AutoGenerator mpg, final PackageConfig pc,final String projectPath){
        // 自定义配置
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
    ...
    public static void strategyConfig(AutoGenerator mpg, PackageConfig pc, String tableName){
        ...
        strategy.setSuperEntityClass("com.tykj.core.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        strategy.setSuperControllerClass("com.tykj.core.web.BaseController");
